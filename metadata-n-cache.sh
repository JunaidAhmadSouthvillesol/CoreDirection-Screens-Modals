...
aws s3 cp --content-type "text/html" --metadata-directive REPLACE s3://live-coredirection-landing-page/terms-and-conditions s3://live-coredirection-landing-page/terms-and-conditions
aws s3 cp --content-type "text/html" --metadata-directive REPLACE s3://live-coredirection-landing-page/cookie-policy s3://live-coredirection-landing-page/cookie-policy
...
aws s3 cp --content-type "text/html" --metadata-directive REPLACE s3://live-coredirection-landing-page/pricing s3://live-coredirection-landing-page/pricing
echo "copy images"
